        ...
        connection(conn)
          .then(() => {
            ...
            collection_doc
              ...
              .then((chart: any | null) => {
                if (chart === null) {
                  reject(new NotSuchChartInSvg("this chart is  not in db"));
                } else {
...
export class NotSuchChartInSvg extends Error {
  constructor(message: string) {
    super(message);
    this.name = "NotSuchChartInSvg";
  }
}
