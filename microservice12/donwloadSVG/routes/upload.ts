...
const path = "utils/Files/svg"; // Set the path to the directory where files will be stored
...
const storage = multer.diskStorage({
  ...
  filename: function (
    ...
    const fileName = `${generateRandomString(11)}.svg`;
...
const upload = multer({
  ...
  fileFilter: (
    ...
    // Check if the uploaded file is of type image/svg+xml
