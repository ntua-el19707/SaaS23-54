        ...
        connection(conn)
          .then(() => {
            ...
            collection_doc
              ...
              .then((chart: any | null) => {
                if (chart === null) {
                  reject(new NotSuchChartInhtml("this chart is  not in db"));
                } else {
...
export class NotSuchChartInhtml extends Error {
  constructor(message: string) {
    super(message);
    this.name = "NotSuchChartInhtml";
  }
}
