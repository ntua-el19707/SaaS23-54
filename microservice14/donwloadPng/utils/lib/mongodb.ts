        ...
        connection(conn)
          .then(() => {
            ...
            collection_doc
              ...
              .then((chart: any | null) => {
                if (chart === null) {
                  reject(new NotSuchChartInpng("this chart is  not in db"));
                } else {
...
export class NotSuchChartInpng extends Error {
  constructor(message: string) {
    super(message);
    this.name = "NotSuchChartInpng";
  }
}
