...
const LineDiagram = {
  ...
  chart: {
    title: {
      text: "Path length vs map size of a random Maze  NxN",
      align: "center",
    },
    series: [
      {
...
const NetworkDiagram = {
  ...
  chart: {
    ...
    title: { text: "The Indo-European Language Tree", align: "left" },
    subtitle: {
...
const PollarDiagram = {
  ...
  chart: {
    chart: { polar: true },
    title: { text: "first", align: "left" },
    subtitle: { text: "se", align: "center" },
    ...
    series: [
      { name: "dokimastiko", type: "line", data: [1, 2, 4, 2, 1, 3, 3, 3] },
    ],
  },
};
const DependencyWheelDiagram = {
  name: "Dependency Wheel Chart",
...
const LineAnotations = {
  name: "Line Annotations Chart",
  path: "LineAnotations",
  chart: {
    chart: {
      type: "area",
